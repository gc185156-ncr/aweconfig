...
awful.keyboard.append_global_keybindings(
    {
        ...
        -- Show Dropdown Term
        awful.key({modkey}, "`", function() awesome.emit_signal("scratch::term") end, {
             description = "Toggle terminal scratchpad", group = "Scratchpad"
        }),

        -- Show Music Controller
        awful.key({modkey}, "p", function() awesome.emit_signal("scratch::music") end, {
        }),
    ...
    awful.mouse.append_client_mousebindings(
        {
            ...
            end), awful.button({}, 2, function(c) c:activate{context = "mouse_click", action = "mouse_move"} end)
        })
end)
